...
function buildAPI(globalOptions, html, jar) {
  ...
  //hajime pogi
  //@syntaxt0x1c: cookie fix ensures Facebook multi-profile sessions pick the right profile id
...
async function loginHelper(appState, email, password, globalOptions, apiCustomized = {}, callback) {
  ...
  mainPromise
    .then(async (res) => {
      ...
      console.log("Fixed", "by @syntaxt0x1c on GitHub for nova-fca");
      try {
